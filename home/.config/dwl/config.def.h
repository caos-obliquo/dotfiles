...
static const char *const autostart[] = {"widle", "-t", "300000",
                                        "wlock", NULL, NULL};
...
static const char *volumemute[] = {"wpctl", "set-mute", "@DEFAULT_AUDIO_SINK@",
                                   "toggle", NULL};
static const char *volumedown[] = {"wpctl", "set-volume",
                                   "@DEFAULT_AUDIO_SINK@", "5%-", NULL};
static const char *volumeup[] = {"wpctl", "set-volume", "@DEFAULT_AUDIO_SINK@",
                                 "5%+", NULL};
